...
//
// Path and PwrqValue are the same string, and both are kept: Path is the name
// a caller writing against Select-String will reach for, and PwrqValue is what
// a downstream cmdlet binds to when the match is piped onward.
var MatchInfo = shape.Fixed("Pwrq.Match",
