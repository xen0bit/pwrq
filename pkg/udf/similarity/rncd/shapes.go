...
var (
	...
	SharedChunksShape = shape.Fixed("Pwrq.Rncd.SharedChunks",
		...
		shape.Prop("Chunks", shape.Array, "the target split into runs, each a Pwrq.Rncd.Chunk"),
	)
	...
	SharedChunkShape = shape.Fixed("Pwrq.Rncd.Chunk",
