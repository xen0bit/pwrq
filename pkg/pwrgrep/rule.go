...
// innerHTML, but not a string literal". rules/pwrgrep.jq holds the operators
// that combine those answers, and a rule is a file that includes it:
//
//	include "pwrgrep";
//
//	# rules: go-weak-hash
